...
public class FormFila extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listFilaPrioridade = new javax.swing.JTextArea();
        ...
        listFilaPrioridade.setEditable(false);
        listFilaPrioridade.setColumns(20);
        listFilaPrioridade.setFont(new java.awt.Font("Segoe UI Light", 0, 24)); // NOI18N
        listFilaPrioridade.setRows(5);
        listFilaPrioridade.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Fila Preferencial", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Light", 0, 24))); // NOI18N
        jScrollPane2.setViewportView(listFilaPrioridade);
    ...
    void mostra(){
        ...
        listFilaPrioridade.setText("");
        if(!filaPrioridade.isEmpty())
            for(Pessoa p:filaPrioridade)
                listFilaPrioridade.append(p+"\n");
    }
    ...
    private void btnAtenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtenderActionPerformed
        ...
        if(!filaPrioridade.isEmpty() ||!filaNormal.isEmpty()){
            if( filaNormal.isEmpty() || cont<=2 && !filaPrioridade.isEmpty() ) {
            Pessoa p = new Pessoa();
          ...
          else if(filaPrioridade.isEmpty() || cont >=2 && !filaNormal.isEmpty()){
            Pessoa p = new Pessoa();
            p = filaNormal.remove();
            lblProx.setText("Prox: "+ p.getNome());
            mostra();
            ...
            JOptionPane.showMessageDialog(null, "Não tem ninguem na Fila!!");
    }
    ...
    private javax.swing.JTextArea listFilaPrioridade;
